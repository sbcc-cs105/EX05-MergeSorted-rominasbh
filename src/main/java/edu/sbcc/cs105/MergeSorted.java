...
public class MergeSorted {
	...
	public static ArrayList<Integer> mergeSorted(ArrayList<Integer> a, ArrayList<Integer> b) {
		...
		return sort;
			...
			ArrayList<Integer> k = new ArrayList<>(Arrays.asList(1,2,4,5,5,7));
			ArrayList<Integer> q = new ArrayList<>(Arrays.asList(2,2,4,5,8));
			ArrayList<Integer> sorted = mergeSorted(k,q);
				for (int val: sorted){
